...
var i_14326 = (self__.level + (1));
while(true){
if((i_14326 <= (new_level + (1)))){
(update[i_14326] = self__.header);

var G__14331 = (i_14326 + (1));
i_14326 = G__14331;
continue;
} else {
}
...
while(true){
if((i <= self__.level)){
var links_14332 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_14332[i]));
} else {
x__$2.forward.push((((i < links_14332.length))?(links_14332[i]):null));
}

if((i < links_14332.length)){
(links_14332[i] = x__$2);
} else {
links_14332.push(x__$2);
}
...
var i_14334 = (0);
while(true){
if((i_14334 <= self__.level)){
var links_14335 = (update[i_14334]).forward;
if((x__$1 === (((i_14334 < links_14335.length))?(links_14335[i_14334]):null))){
(links_14335[i_14334] = (x__$1.forward[i_14334]));

var G__14336 = (i_14334 + (1));
i_14334 = G__14336;
continue;
} else {
var G__14337 = (i_14334 + (1));
i_14334 = G__14337;
continue;
}
} else {
...
var G__14339 = nx;
var G__14340 = (level__$1 - (1));
x = G__14339;
level__$1 = G__14340;
continue;
} else {
var G__14341 = x;
var G__14342 = (level__$1 - (1));
x = G__14341;
level__$1 = G__14342;
continue;
}
...
if(cljs.core.truth_(nx)){
var G__14345 = nx;
var G__14346 = (level__$1 - (1));
x = G__14345;
level__$1 = G__14346;
continue;
} else {
var G__14347 = x;
var G__14348 = (level__$1 - (1));
x = G__14347;
level__$1 = G__14348;
continue;
}
