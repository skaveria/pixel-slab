...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_21180 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_21180(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_21188 = (function (reader){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_21188(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_21190 = (function (reader,ch){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_21190(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_21192 = (function (reader){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_21192(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_21194 = (function (reader){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_21194(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_21196 = (function (reader){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_21196(reader);
}
});
...
var G__21242 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__21243 = s.append(c);
c = G__21242;
s = G__21243;
continue;
}
