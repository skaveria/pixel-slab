...
slab.actions.run_token_BANG_ = (function slab$actions$run_token_BANG_(p__22037){
var map__22038 = p__22037;
var map__22038__$1 = cljs.core.__destructure_map(map__22038);
var el = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22038__$1,new cljs.core.Keyword(null,"el","el",-1618201118));
var info = slab.tokens.token_info(el);
var slot = slab.dom.ensure_output_slot_BANG_(info);
if(cljs.core.truth_(slot)){
slab.dom.show_loading_BANG_(slot);

return slab.net.run_token_BANG_(info).then((function (resp){
var G__22039 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(resp);
...
slab.actions.dispatch_BANG_ = (function slab$actions$dispatch_BANG_(p__22040){
var map__22041 = p__22040;
var map__22041__$1 = cljs.core.__destructure_map(map__22041);
var ctx = map__22041__$1;
var action = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22041__$1,new cljs.core.Keyword(null,"action","action",-811238024));
